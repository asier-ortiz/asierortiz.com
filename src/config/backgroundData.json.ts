...
const academicData: academicItem[] = [
  {
    ...
    description:
      'Specialized in Artificial Intelligence and Data Science, focusing on the design, programming, and deployment of AI algorithms (Machine Learning) and intelligent systems applied in the business world. ' +
