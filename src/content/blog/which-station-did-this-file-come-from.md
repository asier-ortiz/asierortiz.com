...
The brief from a regional water agency in northern Spain was a data-quality job. Thirteen river monitoring stations in two provinces had been recording water-quality readings every ten minutes since 2019, and a sensor contractor delivered them as monthly files. Nobody had checked those files systematically. The agency wanted two things, in order: first an audit report listing every problem in the archive, with nothing altered; then, once the problems were understood, one spreadsheet per station with the complete series on a ten-minute grid. The archive itself was around four thousand files in four formats, with every problem a seven-year archive accumulates.
